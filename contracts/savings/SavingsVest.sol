...
contract SavingsVest is ERC4626Upgradeable, AccessControl, Constants {
    ...
    function initialize(
        ...
        _deposit(msg.sender, address(this), 10 ** numDecimals / divizer, _BASE_18 / divizer);
    }
    ...
    function _convertToShares(
        ...
        return
            (assets == 0 || supply == 0)
                ? assets.mulDiv(_BASE_18, 10 ** _assetDecimals, rounding)
    ...
    function _convertToAssets(
        ...
        return
            (supply == 0)
                ? shares.mulDiv(10 ** _assetDecimals, _BASE_18, rounding)
